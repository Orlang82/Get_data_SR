...
class Config:
    ...
    DATA_COLUMN = 'P'                # Колонка с данными о потерях
    ...
    IMAGE_CELL = 'D9'             # Ячейка для вставки изображения
    ...
    X_MIN_LIMIT = -1.8e6           # Минимальная граница по X
