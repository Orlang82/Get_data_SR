...
START_DATE = datetime(2026, 1, 1)  # Початкова дата
END_DATE = datetime(2026, 2, 1)  # Кінцева дата
OUTPUT_FOLDER = r"r:\Подразделения\РИСК-менеджмент\Внутренние\1 - РЫНОЧНЫЙ РИСК\ТОРГОВА КНИГА\0-2026\01-02-2026\ovdp_data"  # Папка для збереження файлів
